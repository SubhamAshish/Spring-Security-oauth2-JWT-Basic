...
@ComponentScan(basePackages = { "org.sdrc.usermgmt.service", "org.sdrc.JPAtokenstrore","org.sdrc.usermgmt.controller" })
public @interface EnableUserManagementWithOauth2JPATokenStore {
