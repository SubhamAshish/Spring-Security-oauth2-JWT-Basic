package org.sdrc.mongotokenstrore;
...
import org.sdrc.mongotokenstrore.repository.MongoOAuth2AccessTokenRepository;
import org.sdrc.mongotokenstrore.repository.MongoOAuth2RefreshTokenRepository;
...
public class MongoTokenStore implements TokenStore {
	...
	public OAuth2RefreshToken readRefreshToken(final String tokenValue) {
		final String tokenKey = extractTokenKey(tokenValue);
		final MongoOAuth2RefreshToken mongoOAuth2RefreshToken = mongoOAuth2RefreshTokenRepository
	...
	public Collection<OAuth2AccessToken> findTokensByClientIdAndUserName(String clientId, String userName) {
		final List<MongoOAuth2AccessToken> oAuth2AccessTokens = mongoOAuth2AccessTokenRepository
	...
	private Collection<OAuth2AccessToken> transformToOAuth2AccessTokens(
			final List<MongoOAuth2AccessToken> oAuth2AccessTokens) {
